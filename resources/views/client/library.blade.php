                    ...
                    <div class="max-w-2xl">
                        ...
                        <div class="space-y-4 md:space-y-6">
                            ...
                            <figure class="border-2">
                                <a href="{{ asset('assets/New Image/76727002_1382304108618418_7666303799140548608_n.jpg') }}"
                                    class="glightbox2">
                                    <img class="w-full object-cover"
                                        src="{{ asset('assets/New Image/76727002_1382304108618418_7666303799140548608_n.jpg') }}"
