                        ...
                        <div class="space-y-4 md:space-y-3">
                                                ...
                                                <div class="relative overflow-x-auto">
                                                    <div class="block ">
                                                        ...
                                                        <table class="w-full text-left text-sm ">
                                                            <thead>
                                                                <tr class="h-16">
                                                                    <th class="py-2 px-4 border-b">25 hours/1Week</th>
                            ...
                            <div id="accordion-collapse-me1" data-accordion="collapse" class="">
                                ...
                                <div>
                                    <!-- Teacher info 1 -->
                                    <div>
                                        <h2 id="accordion-collapse-heading-me1">
                                            <button type="button"
                                                class="flex items-center justify-between w-full p-3 font-medium rtl:text-right text-gray-500 border border-gray-200  focus:ring-gray-200  hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                                                data-accordion-target="#accordion-collapse-body-me1" aria-expanded="false"
                                                aria-controls="accordion-collapse-body-3">
                                                <span>Faculty of Agronomy
                                                </span>
                                                <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0"
                                        ...
                                        <div id="accordion-collapse-body-me1" class="hidden font-sans  my-2"
                                            aria-labelledby="accordion-collapse-heading-me1">
                                            <div class=" border-dotted border-2 border-[#15803d] ">
                                                <div class="relative overflow-x-auto">
                                                    <div class="block ">
                                                        <div
                                    ...
                                    <div class="mt-2">
                                        <h2 id="accordion-collapse-heading-me2">
                                            <button type="button"
                                                class="flex items-center justify-between w-full p-3 font-medium rtl:text-right text-gray-500 border border-gray-200  focus:ring-gray-200  hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                                                data-accordion-target="#accordion-collapse-body-me2" aria-expanded="fale"
                                                aria-controls="accordion-collapse-body-3">
                                                <span>Faculty of Fishery
                                                </span>
                                                <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0"
                                        ...
                                        <div id="accordion-collapse-body-me2" class="hidden font-sans my-2"
                                            aria-labelledby="accordion-collapse-heading-me2">
                                            <div
                                                class=" border-dotted border-2 border-[#15803d]  dark:border-gray-700 dark:bg-gray-900">
                                                <div class="relative overflow-x-auto">
                                                    <div class="block ">
