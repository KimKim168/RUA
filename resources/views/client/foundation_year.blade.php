                        ...
                        <div class="space-y-4 md:space-y-5">
                            <div class="space-y-3">
                                ...
                                <figure class="border-2">
                                    <a href="{{ asset('assets/New Image/74475947_1382303995285096_5558715999273877504_n.jpg') }}"
                                        class="glightbox2">
                                        <img class="w-full object-cover"
                                            src="{{ asset('assets/New Image/74475947_1382303995285096_5558715999273877504_n.jpg') }}"
                                            alt="Image Description" />
                                    </a>
                                </figure>
                            </div>
                            <div id="accordion-collapse" data-accordion="collapse" class="">
                                <div id="accordion-collapse-body-1" class=" font-sans  my-2"
